...
/scratch/users/dbarreca/private/custom_demux/scRNA/${FLOWCELL}/${FLOWCELL}_1_samples_10x/${FLOWCELL}_1#${RUN_NAME}_02.bam
/scratch/users/dbarreca/private/custom_demux/scRNA/${FLOWCELL}/${FLOWCELL}_1_samples_10x/${FLOWCELL}_1#${RUN_NAME}_03.bam
/scratch/users/dbarreca/private/custom_demux/scRNA/${FLOWCELL}/${FLOWCELL}_1_samples_10x/${FLOWCELL}_1#${RUN_NAME}_04.bam
/scratch/users/dbarreca/private/custom_demux/scRNA/${FLOWCELL}/${FLOWCELL}_2_samples_10x/${FLOWCELL}_2#${RUN_NAME}_01.bam
/scratch/users/dbarreca/private/custom_demux/scRNA/${FLOWCELL}/${FLOWCELL}_2_samples_10x/${FLOWCELL}_2#${RUN_NAME}_02.bam
/scratch/users/dbarreca/private/custom_demux/scRNA/${FLOWCELL}/${FLOWCELL}_2_samples_10x/${FLOWCELL}_2#${RUN_NAME}_03.bam
/scratch/users/dbarreca/private/custom_demux/scRNA/${FLOWCELL}/${FLOWCELL}_2_samples_10x/${FLOWCELL}_2#${RUN_NAME}_04.bam
)
